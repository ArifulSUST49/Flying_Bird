...
//menu music
    SoundBuffer menusoundbuffer;
     menusoundbuffer.loadFromFile("menusound.wav");
    Sound MenuSound;
...
int main()
{
    ...
    game.font.loadFromFile("arif.ttf");
    ...
    game.pressB.setString("Press C to restart");
    game.pressC.setString("Press Escape to go");
    game.pressD.setString(" back main menu");
    game.pressP.setString("Paused");
    game.pressF.setString("Press Space to Flap Again");
    ...
    game.pressC.setFillColor(Color::Magenta);
    game.pressP.setFillColor(Color::Black);
    game.pressF.setFillColor(Color::Red);
    game.pressL.setFillColor(Color::Cyan);
    game.pressD.setFillColor(Color::Magenta);
    ...
    game.pressF.setCharacterSize(60);
    ...
    game.pressF.setOrigin(game.pressC.getLocalBounds().width / 2, 0);
    ...
    game.pressF.setPosition(300, 400);
